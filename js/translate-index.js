function ita() {
  ...
  document.getElementById('p1').innerHTML = "icone: fontawesome <br>Vivi che corre <a href='https://gifer.com/en/ZZ57' target='_blank'>@gifer</a> <br> fonts: google fonts e 1001fonts<br>script per le animazioni quando si scrolla da <a href='http://jsfiddle.net/ravimallya/mhfcwyk8/1/' target='_blank'>@ravimallya</a><br> immagini di sfondo modificate da me, arte originale by ractapopulous.";
...
function eng() {
  ...
  document.getElementById('subtitle').innerHTML = "web designer, writer, tvshow-enthusiast*";
  ...
  document.getElementById('p1').innerHTML = "icons: @fontawesome <br>animated Vivi running @<a href='https://gifer.com/en/ZZ57'>gifer</a> <br> fonts: google fonts and 1001fonts<br>script for animations happening on scroll by <a href='http://jsfiddle.net/ravimallya/mhfcwyk8/1/' target='_blank'>@ravimallya</a><br> background-images edited by me, original static art by ractapopulous.";
